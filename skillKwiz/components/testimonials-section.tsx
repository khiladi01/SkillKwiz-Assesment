...
export default function TestimonialsSection() {
  ...
  const updateVisibleTestimonials = useCallback((index: number) => {
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <button
            onClick={goToPrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-30 bg-white rounded-full p-2 shadow-md hover:bg-gray-100 focus:outline-none hidden md:block transition-colors"
          ...
          <button
            onClick={goToNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-30 bg-white rounded-full p-2 shadow-md hover:bg-gray-100 focus:outline-none hidden md:block transition-colors"
          ...
          <div className="flex justify-center items-center gap-4 mb-8 overflow-hidden px-4 min-h-[400px] md:min-h-[350px]">
                ...
                className={`
                  ...
                  ${
                    index === 1
                      ...
                      : "hidden md:flex md:w-[25%] h-[250px] p-3 opacity-70 z-10 shadow-md"
                  }
                `}
              >
